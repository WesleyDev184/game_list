...
const showGames = (data) => {
  ...
  data.map((item) => {
    ...
    li.innerHTML = `
            ...
            <div
            id="card"
            class="border rounded-lg shadow-md bg-gray-800 border-gray-700 transition hover:-translate-y-1 hover:scale-110 hover:bg-indigo-600 duration-300"
            >
            <div class="flex justify-center" id="img_card">
                <img class="rounded-t-lg" src="${item.thumbnail}" alt="${item.title}" />
            </div>
            <div class="p-5 h-56 grid grid-rows-4" id="info">
              <div class="row-span-1" id="title_Card">
                <h5
              ...
              <div class="row-span-2 overflow-y-hidden overflow-y-scroll" id="desc">
              ...
              <div class="row-span-1 flex items-end justify-between">
                ...
                <button id="btn" type="button" class="text-white font-medium rounded-lg text-sm px-5 py-1 text-center inline-flex items-center mr-2 bg-emerald-500 hover:bg-emerald-800 focus:bg-emerald-400">
